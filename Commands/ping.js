exports.run = (client, msg, args) => {
    ...
    msg.channel.send(`Please wait until we check the bot's latency...`).then(function(m) {
        m.edit({embed: {
            ...
            description: `:ping_pong: **Melon** v1.1 by BriciWorld, Casbas 234, and Hydrogen, is running for ${format(uptime)}. Serving ${client.users.size} users in ${client.guilds.size} servers. :dizzy:`,
            footer: {
